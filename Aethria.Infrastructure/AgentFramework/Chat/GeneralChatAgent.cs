...
internal sealed class GeneralChatAgent : IChatAgent
{
    ...
    {
        var agent = CreateAgent(context.Tools ?? []);
    ...
    private AIAgent CreateAgent(IReadOnlyList<string> tools)
    {
        ...
        var agent = builder.Build().AsAIAgent(
            ...
            instructions: ChatAgentInstructions.GeneralChatAgentInstruction,
            tools: aiTools);

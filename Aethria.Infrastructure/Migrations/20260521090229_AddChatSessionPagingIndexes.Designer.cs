...
namespace Aethria.Infrastructure.Migrations
{
    ...
    [Migration("20260521090229_AddChatSessionPagingIndexes")]
    partial class AddChatSessionPagingIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Aethria.Domain.Entities.ChatSession", b =>
                {
                    ...
                    b.HasIndex("MentorId", "UserId", "UpdatedAt")
                        .IsDescending(false, false, true)
                        .HasDatabaseName("ix_chat_sessions_mentor_id_user_id_updated_at");

                    b.HasIndex("ResourceId", "UserId", "UpdatedAt")
                        .IsDescending(false, false, true)

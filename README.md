...
- `Aethria.Application`: DispatchR use cases, validation pipelines, abstractions, and API/MCP-specific service registration.
- `Aethria.Infrastructure`: EF Core persistence, Identity, Azure Blob Storage, embeddings, chunking, AI agent integrations, and feature-scoped service registration.
- `Aethria.Api`: REST endpoints, SignalR hubs, JWT authentication, OpenAPI, Scalar UI, and full API service composition.
...
│   ├── Entities/                # Enterprise/domain logic models (User, Resource, Mentor, Quiz, Roadmap)
...
│   ├── Abstractions/            # Interfaces for external dependencies (Storage, Embeddings, LLM)
